...
\frame{
    \frametitle{Introduction and motivation}
        Non Newtonian fluids have a wide range of applications. This include
        \begin{itemize}[<+->]
        \item toothpaste
        \item liquid plastic
        \item granular flow
...
\begin{frame}
    ...
    \end{itemize}
\uncover<3->{Now take a look at the finger tensor equation.}
\end{frame}
\begin{frame}
    \frametitle{Dimension reduction}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \subfigure{\includegraphics[width=0.4\textwidth]{centerlinevel}}
...
\begin{frame}
    ...
    \end{itemize}
\uncover<4->{First two may be answered at the end of the work.}
\end{frame}
\begin{frame}
